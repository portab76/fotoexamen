...
<head>
    ...
    <title>FotoExamen: Captura y Resuelve tus Dudas.</title>
	<link rel="icon"  href="https://elper.es/enlaces/favicon.ico" type="image/x-icon"/>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet">
    <script>
        // Esta función se encarga de manejar el formulario y preparar los datos para el servidor Java
		let textPrompt1 = "Identifica los numeros de pregunta , textos preguntados y respuesteas de la imagen adjunta."
		+ " Debes obtener los resultados  formateados como json siguiendo el siguiente esquema: "
		+ "{ \"numero\":int,\"pregunta\": texto,\"respuestas\":texto}, "
		...
		+ "Debes obtener los resultados formateados como json siguiendo el siguiente esquema: "
		+ "{ \"letra\":texto,\"respuesta\": texto,\"razonamiento\": texto} " 
		+ "Donde 'letra' corresponde a la letra de la respuesta correcta, 'respuesta' referencia al temario por el cual se a seleccionado la respuesta correcta."
		+ "y 'razonamiento' calculos o breve explicacion de la  pregunta: #pregunta# #respuestas# ";
		let urljson = "https://elper.es/";
	...
	<style>
		.form-check-inline {
			margin-right: 15px; /* Espaciado entre los radio buttons */
		}
        .button {
			margin-left: 5px
            padding: 10px 20px;
...
<body>
    <div class="container mt-5">
		<div class="mt-5 d-flex justify-content-center">    
			<h4 class="mb-4">Enviar Imagen de examen:</h4>
		</div>
		<div class="form-group">
			...
			<div class="form-check form-check-inline">
				<input class="form-check-input" type="radio" name="imageSource" id="fileRadio" value="file" onclick="disableOthers('file')" checked/>
		...
		<input type="text" id="urlInput" name="url" class="form-control" disabled="disabled" style="display:none; margin-top: 10px;" />
		<input type="file" id="fileInput" name="file" class="form-control-file form-control" accept="image/*" style="margin-top: 10px;" />
		<input type="file" id="cameraInput" name="camera" class="form-control-file form-control" accept="image/*" capture="camera" style="display:none; margin-top: 10px;" />
		<!-- RESPUESTA ABREVIADA -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
						<label class="form-check-label" for="cameraRadio">Promp 1:</label>
                        <textarea class="form-control" id="textPrompt1" name="textPrompt1" rows="5" style="min-height:250px"></textarea>
						<br>
						<label class="form-check-label" for="cameraRadio">Promp 2:</label>
